...
export declare function context<T>(context: React.Context<T>): T;
export declare function deferredValue<T>(initialValue: Ref<T>): Readonly<Ref<T>>;
export declare function createDirective<T>(directive: T): T;
export declare function reactivity<T>(component: (props: T) => () => ReactNode): React.FC<T>;
export declare function createReactivityDirective(manager: Context): typeof reactivity;
...
export declare function layoutEffect(effect: WatchEffect, options?: WatchOptionsBase): WatchStopHandle;
export declare function insertionEffect(effect: WatchEffect, options?: WatchOptionsBase): WatchStopHandle;
export declare function transition(): void;
export declare function tickListener(): () => Promise<void>;
export declare function toDirective<T extends ReactHook>(hook: T): (...args: Parameters<T>) => ToRefs<ReturnType<T>>;
export declare function toDirectiveShallow<T extends ReactHook>(
  hook: T,
